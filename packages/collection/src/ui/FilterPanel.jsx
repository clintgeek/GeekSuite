 ...
 * list, sticky inside the library's scroll container so it stays put while
 * the list scrolls, with its own scroll when the sections run long.
 *
...
export default function FilterPanel({ sections, lib, facets, context, open, onToggleSection, onHide, title = 'Filters' }) {
  ...
  return (
    ...
    >
      ...
      <FilterSections sections={sections} lib={lib} facets={facets} context={context} open={open} onToggleSection={onToggleSection} />
    </Box>
  );
}
