...
import { getMe, loginRedirect, logout as logoutServer, onLogout as onLogoutBroadcast, startRefreshTimer, stopRefreshTimer } from '@geeksuite/auth';
        ...
        (set, get) => {
            ...
            return {
                ...
                login: async () => {
                    ...
                    loginRedirect('notegeek', window.location.href, 'login');
                    return { redirected: true };
                },

                register: async () => {
                    loginRedirect('notegeek', window.location.href, 'register');
                    return { redirected: true };
                },
