...
- OBJECTS THE PLAYER WORKS WITH: when the player examines, repairs, or uses a specific object, record its distinguishing physical characteristics as facts (mechanism type like analog vs digital, make, condition, notable features). These details WILL be referenced again and must not drift.
