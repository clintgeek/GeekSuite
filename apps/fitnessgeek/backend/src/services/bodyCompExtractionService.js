...
const RESPONSE_SHAPE = `{
  ...
  "primaries": {
    ...
    "protein_lb": <lb>, "bone_mass_lb": <lb>, "skeletal_muscle_lb": <lb>,
  ...
  "printed": {
    "fat_free_mass_lb": <lb>, "muscle_mass_lb": <lb>,
    "body_fat_pct": <%>, "body_water_pct": <%>, "protein_pct": <%>,
    "bone_mass_pct": <%>, "skeletal_muscle_pct": <%>, "subcutaneous_fat_pct": <%>, "muscle_mass_pct": <%>,
