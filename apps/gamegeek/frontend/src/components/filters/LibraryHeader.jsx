...
export default function LibraryHeader({
  ...
  const count = (
    <Typography
      ...
      sx={{
        ...
        ...(isDesktop
          ? { fontFamily: DISPLAY_FONT, fontSize: '1.125rem', fontWeight: 600, letterSpacing: '-0.01em', color: 'text.primary' }
  ...
  const sort = (
    <SortMenu sort={state.sort} dir={state.dir} onSort={lib.setSort} onReshuffle={lib.reshuffle} compact={!isDesktop} />
  );
