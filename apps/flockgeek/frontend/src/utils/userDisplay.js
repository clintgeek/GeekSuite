 ...
 * chip, the top bar account menu and the settings page all funnel through
 * here rather than each guessing differently.
 */

/** Best human-readable name we have, or "Caretaker" when we have nothing. */
